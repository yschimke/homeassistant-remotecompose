# Terrazzo · Home Assistant RemoteCompose — design artifacts

Importable sticker-sheet for **`androidx.compose.material3:material3`**, rendered from the committed
`@Preview` catalog in [`yschimke/homeassistant-remotecompose`](https://github.com/yschimke/homeassistant-remotecompose). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/homeassistant-remotecompose/blob/design-artifacts/homeassistant-remotecompose/index.html)**
...
**[▶ Open the PNG↔SVG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/homeassistant-remotecompose/blob/design-artifacts/homeassistant-remotecompose/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/homeassistant-remotecompose/)**

The same rendered components, served live by `compose-preview serve --catalogs homeassistant-remotecompose` —
...
| Renderer | compose-preview 0.16.59 |
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/homeassistant-remotecompose/blob/design-artifacts/homeassistant-remotecompose/index.html) |
| `compare.html` | PNG↔SVG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/homeassistant-remotecompose/blob/design-artifacts/homeassistant-remotecompose/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/homeassistant-remotecompose/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/yschimke/homeassistant-remotecompose/actions/workflows/design-artifacts.yml)
