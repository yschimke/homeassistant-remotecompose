...
/**
 * Identity tier for the `logbook` family — the latest entry only: its
 * icon, name, what changed and when. The smallest cell that still says
 * "here's the most recent activity"; drops the older entries (P5) but
 * keeps the P1 identity (latest entry). Used by the Fixed-mode converter
 * at narrow launcher / Wear cells; see
